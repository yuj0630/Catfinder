	...
	<body class="landing is-preload">
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Banner -->
					<section id="banner"  style="background-image: url(images/1.jpg); background-repeat:repeat-x">
						<div class="inner">

							<h2 style="color:orange; font-size:40px;"><a href="index.html" style="text-decoration:none !important; ">식빵굽냥</a></h2>
							<p>가톨릭대학교<br />
							길냥이 커뮤니티<br />
							정보시스템 개론 1조</p>
					...
					<section id="one" class="wrapper style1 special" style="background-color:LightPink   ">
						<div class="inner">
							<header class="major"  >
								...
								<br>
								<br>
								<p><b>각 지역에서 운영하는 몇 개의 카페 입니다.</b></p>
							</header>
							<ul class="icons major">
								<li><a href="#" class="icon fa-diamond major style1"></a><span class="label"></span></li> <!-- 여기 href에 3개정도 커뮤니티 링크 넣어줘야함-->
								<li><a href="#" class="icon fa-heart-o major style2"></a><span class="label"></span></li>
								<li><a href="#" class="icon fa-star major style3" style="color:orange"></a><span class="label"></span></li>
							</ul>
						</div>
					</section>
					...
					<section id="two" class="wrapper alt style2">
						<section class="spotlight">
							<div class="image"><a href="registAndSearch.jsp"><img src="images/index1.jpg" alt="인덱스 첫번째 고양이"></a></div><div class="content">
								...
								<ul><span style="display:inline-block; padding:0; font-size:20px">What kind of cat does our town have?</span></ul>
						...
						<section class="spotlight">
							<div class="image"><a href="boardElement.jsp"><img src="images/index2.jpg" alt="크림히어로즈 3마리" /></a></div><div class="content">
								<h2>분양 받고 싶죠? 냥이 사진 보고 싶죠?</h2>
									<ul><span style="display:inline-block; padding:0; font-size:20px">Parcelling out and photo board</span></ul>
